...
| `paperless_ngx_version` | latest | Sofware version to install. Use `latest` or any specific version in the format `'2.18.0'`. Only `paperless_ngx_version_minimum: '2.18.0'` and higher supported. |
| `` |  |  |
